...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white" title="Account Settings">Change Price</i></a>
  <a href="AllBooks.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-orange" title="Messages">View</a>
...
<form class="w3-panel w3-center w3-card-2" action="ChangePrice" method="post">
  <h2>Change Price</h2>
  ...
  <p><button class="w3-btn w3-black" type="submit" onclick="document.getElementById('id01').style.display='block'" class="w3-btn w3-blue">SAVE</button></p>
